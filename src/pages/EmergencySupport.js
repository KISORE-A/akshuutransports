...
export default function EmergencySupport() {
  ...
  const playRingingSound = () => {
    ...
    audioRef.current = { audioContext, isPlaying: true, stopRinging: () => { isPlaying = false; } };
    playRing();
  };
  ...
  const speakInitialResponse = () => {
    ...
    if (type === "Police") {
      initialMessage = "Hello sir or madam, this is police emergency services. What is the problem? Please describe the situation.";
    } else {
      initialMessage = "Hello sir or madam, this is hospital emergency services. Where is the location? What happened to them?";
    }
  ...
  const startListening = () => {
    ...
    recognition.onresult = (event) => {
      ...
      // Stop after 2 seconds of silence if we have some speech
    ...
    recognition.onend = () => {
      ...
      console.log('Final transcript:', finalText); // Debug log
      ...
      if (finalText) {
        ...
        setTimeout(() => {
          ...
          // Automatically start listening again after response (like a real call)
          setTimeout(() => {
            if (callStatus === "connected") {
              startListening();
            }
          }, 3000); // Wait 3 seconds after speaking the response
        }, 500);
      } else {
          ...
          <div className="conversation-container">
            <div className="messages-list">
              {messages.map((msg, idx) => (
                <div key={idx} className={`message ${msg.sender === "You" ? "user-message" : "service-message"}`}>
